...
import styles from './carInfo.less'
class CarListInfo extends React.Component {
    ...
    onChange = (item,index,key) => {
        ...
        let indexTop = key=="indexTop"?index:''
        let indexBotton = key=="indexTop"?'':index
    ...
    render() {
        let {carListInfo, rechargeTotal, rechargeCurrent,indexTop,indexBotton, carTitleName, dataInfo} = this.state;
        ...
        return (
            <div className="carInfoContent">
                 <div className='headerButtonBox' >
                    <div>
                        {BUTTON_TOP.map((item,index) =>
                            <div className={'bottonItem '+ (index==indexTop&&indexTop!==''?' activeStyles':'')} key={index+'BUTTON_TOP'}>
                                <div className="buttonList cursorPointer" onClick={() => this.onChange(item,index,'indexTop')}>
                                    <p>{item.title}</p>
                                    <p>{item.value}</p>
                                </div>
                                <i></i>
                ...
                <div className='headerButtonBox' >
                    <div>
                        {BUTTON_DOWN.map((item,index) =>
                            <div className={'bottonItem'+ (index==indexBotton&&indexBotton!==''?' activeStyles':'')} key={index+'BUTTON_DOWN'}>
                                <div className="buttonList cursorPointer" onClick={() => this.onChange(item,index,'indexBotton')}>
                                    <p>{item.title}</p>
                                    <p>{item.value}</p>
                                </div>
                                <i></i>
...
const searchStyle={ marginLeft: '300px'};
